...
if("FALSE" STREQUAL "TRUE")
  set(kobuki_description_SOURCE_PREFIX /tmp/binarydeb/ros-kinetic-kobuki-description-0.7.4)
  set(kobuki_description_DEVEL_PREFIX /tmp/binarydeb/ros-kinetic-kobuki-description-0.7.4/obj-x86_64-linux-gnu/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kobuki_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/kinetic/${idir}'.  Ask the maintainer 'Younghun Ju <yhju@yujinrobot.com>' to fix it.")
    endif()
